...
- interval: Frame interval (default: 30)

**Best For**:

- Consistent sampling
- Time-based analysis
- Predictable output count
...
- threshold: Scene change sensitivity (default: 20)
...
- Dynamic content with scene changes
- Minimal storage (fewer frames)
...
**TC-801: Valid MP4 Upload**

**Expected**: 200 OK, extraction succeeds ✅

**TC-802: Valid AVI Upload**

**Expected**: 200 OK, extraction succeeds ✅

**TC-803: Valid MOV Upload**

**Expected**: 200 OK, extraction succeeds ✅

**TC-804: Invalid File Format (PDF)**

**Expected**: 400 Bad Request, "Invalid file type" ✅

**TC-805: File Size Exceeds 500MB**

**Expected**: 413 Request Entity Too Large ✅

**TC-806: Empty File Upload**

**Expected**: 400 Bad Request, "No file selected" ✅

**TC-807: Non-English Filename (中文.mp4)**

**Expected**: 200 OK, UUID handling successful ✅

**TC-808: Corrupted Video File**

**Expected**: 400 Bad Request, "Cannot open video file" ✅

**Category 2: Fixed Interval Extraction (6 test cases)**

**TC-809: Interval 30 Frames**

**Expected**: Consistent frame extraction every 30 frames ✅

**TC-810: Interval 60 Frames**

**Expected**: Half the keyframes vs interval 30 ✅

**TC-811: Interval 1 Frame**

**Expected**: All frames extracted (very large output) ✅

**TC-812: Custom Interval 120 Frames**

**Expected**: Extraction every 120 frames ✅

**TC-813: Video Shorter Than Interval**

**Expected**: At least one frame extracted (middle frame) ✅

**TC-814: Fixed Method Performance**

**Expected**: Faster than difference method ✅

**Category 3: Scene Difference Extraction (10 test cases)**

**TC-815: Threshold 20 (Default)**

**Expected**: Balanced scene detection ✅

**TC-816: Threshold 10 (Sensitive)**

**Expected**: More keyframes, minor changes detected ✅

**TC-817: Threshold 50 (Conservative)**

**Expected**: Fewer keyframes, only major scene changes ✅

**TC-818: Dark Video Scene Changes**

**Expected**: Histogram equalization enables detection ✅

**TC-819: Bright Video Scene Changes**

**Expected**: Brightness normalized, scenes detected ✅

**TC-820: Low Bitrate Compression Artifacts**

**Expected**: Gaussian blur filters noise, valid detection ✅

**TC-821: Fast Action Sequence**

**Expected**: Multiple rapid scene changes captured ✅

**TC-822: Slow Fade Transitions**

**Expected**: Gradual changes detected appropriately ✅

**TC-823: Static Scene Fallback**

**Expected**: Force extraction every 30 seconds ✅

**TC-824: Scene Duration Filtering**

**Expected**: Scenes < 1s skipped, count reported ✅

**Category 4: Edge Case Handling (10 test cases)**

**TC-825: Video with Corrupted Frames**

**Expected**: Skip corrupted, continue processing ✅

**TC-826: All Black Frames**

**Expected**: Minimal scene changes, fallback triggers ✅

**TC-827: All White Frames**

**Expected**: Similar to black frames handling ✅

**TC-828: Single Frame Video**

**Expected**: One keyframe extracted ✅

**TC-829: 1-Hour Long Video**

**Expected**: Successful extraction, long processing time ✅

**TC-830: Variable Frame Rate (VFR)**

**Expected**: Handled correctly, FPS calculated ✅

**TC-831: Video with No Audio**

**Expected**: No impact on extraction ✅

**TC-832: Rotated Video (90°)**

**Expected**: Frames extracted with rotation preserved ✅

**TC-833: Multiple Concurrent Uploads**

**Expected**: UUID prevents conflicts, all succeed ✅

**TC-834: Interlaced Video**

**Expected**: Frames extracted despite interlacing ✅

**Category 5: Output Format & Quality (6 test cases)**

**TC-835: JPG Output (Default)**

**Expected**: JPEG files in ZIP ✅

**TC-836: PNG Output**

**Expected**: PNG files in ZIP (larger size) ✅

**TC-837: Filename Format Accuracy**

**Expected**: Correct frame number and timestamp ✅

**TC-838: ZIP File Integrity**

**Expected**: Valid ZIP, extractable ✅

**TC-839: Keyframe Image Quality**

**Expected**: No quality degradation vs original ✅

**TC-840: Metadata Accuracy**

**Expected**: Correct counts, FPS, processing time ✅

**Category 6: Performance (5 test cases)**

**TC-841: 30-Second Video Processing Time**

**Expected**: < 5 seconds ✅

**TC-842: 5-Minute Video Processing Time**

**Expected**: < 30 seconds ✅

**TC-843: 1080p vs 720p vs 480p**

**Expected**: Higher resolution = longer processing ✅

**TC-844: Fixed vs Difference Method Speed**

**Expected**: Fixed method faster ✅

**TC-845: Memory Usage During Processing**

**Expected**: < 1GB for typical videos ✅
...
**EC-1: All Black Frames Video ✅**

**Result**: Fallback triggered, 1 frame extracted every 30s

**EC-2: Single Frame Video ✅**

**Result**: One keyframe extracted successfully

**EC-3: Variable Frame Rate ✅**

**Result**: Average FPS calculated, extraction successful

**EC-4: Rotated Video (90°) ✅**

**Result**: Rotation preserved in keyframes

**EC-5: Non-English Filename (日本語.mp4) ✅**

**Result**: UUID naming prevented issues

**EC-6: Concurrent Upload Stress Test ✅**

**Result**: 10 simultaneous uploads, all successful

**EC-7: Very Short Video (0.5s) ✅**

**Result**: Middle frame extracted as fallback

**EC-8: Very Long Video (90 minutes) ✅**

**Result**: 125 keyframes, processing time 3.2 minutes

**EC-9: Interlaced Video ✅**

**Result**: Deinterlaced automatically by OpenCV

**EC-10: Video with Metadata Only (No Visual) ✅**

**Result**: Validation failed correctly
...
**Overall Test Result**: **50/50 PASS (100%)**
...
\_Last Updated: December 22, 2024_d | Skipped | Result | |---|--------|----------|-----|--------|-----------|-----------|----------|-----------|---------|--------| | 1 | MP4 | 2:15 | 30 | difference | 20 | 23 | 15.2 | 0 | 2 | ✅ PASS | | 2 | MP4 | 1:45 | 30 | difference | 20 | 18 | 11s.8 | 0 | 1 | ✅ PASS | | 3 | MOV | 3:00 | 24 | difference | 20 | 28 | 18.4 | 0 | 3 | ✅ PASS | | 4 | MP4 | 1:30 | 60 | difference | 20 | 20 | 14.7 | 0 | 1 | ✅ PASS | | 5 | MP4 | 2:30 | 30 | difference | 15 | 35 | 16.9 | 0 | 4 | ✅ PASS | | 6 | MP4 | 2:00 | 30 | fixed | 30 | 60 | 10.2 | 0 | 0 | ✅ PASS | | 7 | AVI | 1:20 | 30 | difference | 20 | 15 | 9.8 | 0 | 1 | ✅ PASS | | 8 | MP4 | 4:00 | 30 | difference | 20 | 42 | 24.1 | 0 | 5 | ✅ PASS | | 9 | MKV | 2:45 | 30 | difference | 20 | 30 | 17.3 | 0 | 2 | ✅ PASS | | 10 | MP4 | 1:50 | 30 | difference | 20 | 19 | 12.5 | 0 | 1 | ✅ PASS |
